...
if os.path.isfile("label_list_mod"):
    ...
    # =================================================================
    with open("label_list_mod", "r") as labels:
        for line in labels:
            content = line.split()
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        X_t2, y_t2, test_size=.3, random_state=1)
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        X_t5, y_t5, test_size=.3, random_state=24)
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        X_t6, y_t6, test_size=0.40, random_state=52)
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        X_t7, y_t7, test_size=.40, random_state=90)
    ...
    classifiers.extend([clf1, clf2, clf3, clf4, clf5, clf6, clf7, clf8])
